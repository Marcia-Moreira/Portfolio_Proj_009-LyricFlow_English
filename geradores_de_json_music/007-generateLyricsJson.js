...
const txtFilePath = path.join(__dirname, '../lyrics/007.txt');
const jsonFilePath = path.join(__dirname, '../lyrics/007.json');
...
fs.readFile(txtFilePath, 'utf8', (err, data) => {
    ...
    lyrics.push({
        ...
        text_pt: "Composição: Rocky Block / Teddy Swims / John Ryan / Julian Bunetta / Matt Zara / Mikky Ekko / Sarah Solovay",
        text_en: "Composition: Rocky Block / Teddy Swims / John Ryan / Julian Bunetta / Matt Zara / Mikky Ekko / Sarah Solovay",
        text_pron: "Cômpozíshon: Rocky Block / Teddy Swims / John Ryan / Julian Bunetta / Matt Zara / Mikky Ekko / Sarah Solovay" // Pronúncia da composição
    });
    ...
    const jsonOutput = {
        title: "Bad Dreams",
        artist: "Teddy Swims",
        composer: "Rocky Block / Teddy Swims / John Ryan / Julian Bunetta / Matt Zara / Mikky Ekko / Sarah Solovay",  //! <- Adiciona a composição aqui
