...
const txtFilePath = path.join(__dirname, '../lyrics/006.txt');
const jsonFilePath = path.join(__dirname, '../lyrics/006.json');
...
fs.readFile(txtFilePath, 'utf8', (err, data) => {
    ...
    lyrics.push({
        ...
        text_pt: "Composição: Ivan Khatchoyan / Jake Mason / Lance Ferguson",
        text_en: "Composition:Ivan Khatchoyan / Jake Mason / Lance Ferguson",
        text_pron: "Cômpozíshon: Ivan Khatchoyan / Jake Mason / Lance Ferguson" // Pronúncia da composição
    });
    ...
    const jsonOutput = {
        ...
        composer: "Ivan Khatchoyan / Jake Mason / Lance Ferguson",  //! <- Adiciona a composição aqui
        audioSrc: "./audio/006.m4a",
