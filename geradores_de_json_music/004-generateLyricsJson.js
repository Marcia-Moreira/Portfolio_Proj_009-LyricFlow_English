...
const txtFilePath = path.join(__dirname, '../lyrics/004.txt');
const jsonFilePath = path.join(__dirname, '../lyrics/004.json');
...
fs.readFile(txtFilePath, 'utf8', (err, data) => {
    ...
    lyrics.push({
        ...
        text_pt: "Composição: Adam Levine / Jacob Kasher / Jon Bellion / Jordan K. Johnson / Michael Pollack / Stefan Johnson / Vincent Ford",
        text_en: "Composition: Adam Levine / Jacob Kasher / Jon Bellion / Jordan K. Johnson / Michael Pollack / Stefan Johnson / Vincent Ford",
        text_pron: "Cômpozíshon: Adam Levine / Jacob Kasher / Jon Bellion / Jordan K. Johnson / Michael Pollack / Stefan Johnson / Vincent Ford" // Pronúncia da composição
    });
    ...
    const jsonOutput = {
        title: "Memories",
        artist: "Maroon 5",
        composer: "Adam Levine / Jacob Kasher / Jon Bellion / Jordan K. Johnson / Michael Pollack / Stefan Johnson / Vincent Ford",  //! <- Adiciona a composição aqui
        audioSrc: "./audio/007.m4a",
