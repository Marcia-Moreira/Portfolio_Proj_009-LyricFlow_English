...
// => Arquivo JSON salvo em: C:\Portfolio_Marcia_Moreira-GERAL\Portfolio_Proj_009-LyricFlow_English\lyrics\001.json
...
fs.readFile(txtFilePath, 'utf8', (err, data) => {
    ...
    lyrics.push({
        ...
        text_en: "Composição: Bernie Taupin / Elton John",
        text_pron: "Composição: Bernie Taupin / Elton John", // Pronúncia da composição
    });
