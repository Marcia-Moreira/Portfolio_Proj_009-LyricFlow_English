...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        ...
        document.getElementById("audio-source").src = musicData.audioUrl;
        document.getElementById("audio-player").load(); // Atualiza o player com a nova música
